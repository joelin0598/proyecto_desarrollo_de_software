...
type AdminSidebarProps = {
  ...
  role?: string
  loading: boolean
  activeSection?: 'dashboard' | 'triage' | 'triage-list'
  collapsed?: boolean
...
const AdminSidebar: React.FC<AdminSidebarProps> = ({
  ...
  return (
    <aside className={`bg-blue-100/85 border-r border-blue-200 shadow-sm p-4 flex flex-col justify-between transition-all duration-300 ${collapsed ? 'w-20' : 'w-64'}`}>
      <div>
