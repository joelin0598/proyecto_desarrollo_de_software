...
/**
 * DTO para el registro de personal hospitalario en el sistema.
 * Crea un registro en usuario_sistema (con el rol indicado) y en personal_hospitalario.
...
public class RegisterPersonalRequest {
    ...
    /** Número de colegiado profesional (requerido para médicos). */
