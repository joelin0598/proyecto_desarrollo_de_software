...
public class VitalSignsMapper {
    ...
    public VitalSigns toDomain(VitalSignsJpaEntity entity){
        ...
        return VitalSigns.builder()
                ...
                .pacienteId(entity.getPacienteId() != null ? entity.getPacienteId().getPacienteId() : null)
                .personalId(entity.getPersonalId() != null ? entity.getPersonalId().getPersonalId() : null)
