...
- Jonathan Guamuch - Backend (Java/Spring Boot) -Frontend (React/TypeScript) - DevOps (Azure/GitHub Actions) -Documentación técnica y visual - Coordinación general del proyecto
