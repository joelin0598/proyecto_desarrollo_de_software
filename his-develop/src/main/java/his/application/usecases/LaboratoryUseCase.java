...
public interface LaboratoryUseCase {
    ...
    LaboratoryOrderResponse validatePayment(Long ordenLaboratorioId, LaboratoryPaymentRequest req, String emailLaboratorista);
    List<LaboratoryOrderResponse> getOrdersByPatientDpi(String dpi);
    LaboratoryOrderResponse receiveSample(Long ordenLaboratorioId, String emailLaboratorista);
    LaboratoryOrderResponse startProcessing(Long ordenLaboratorioId, String emailLaboratorista);
